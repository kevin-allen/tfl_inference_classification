...
/*
./inference_base_conv_and_head ../python/resnet50_conv_base_model_optim_default.tflite ../python/resnet50_classifier_model_optim_default.tflite  ../data/cat.jpg
...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Model classifier head: " << model_classifier_head_file << std::endl;
